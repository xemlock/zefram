...
/**
 * @see https://github.com/zendframework/zf1/blob/master/tests/Zend/Controller/Action/Helper/RedirectorTest.php
...
class Zend_Controller_Action_Helper_RedirectorTest extends PHPUnit_Framework_TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->redirector = new Zefram_Controller_Action_Helper_Redirector();
    ...
    public function testSetGotoRoute()
    {
        ...
        // Zefram_Controller_Action_Helper_Redirector::setGotoRoute(): route name first
        $this->redirector->setGotoRoute(
            'blogArchive',
            array('id' => 137)
        );

        $this->assertEquals('/blog/archive/137', $this->redirector->getRedirectUrl());
    }
    ...
    public function testGotoRoute()
    {
        ...
        // Zefram_Controller_Action_Helper_Redirector::gotoRoute(): route name first
        $this->redirector->gotoRoute(
            'blogArchive',
            array('id' => 137)
        );
