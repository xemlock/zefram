...
/**
 * Replacement for {@link Zefram_Tool_Framework_Client_Console_Manifest}
 * that resets 'actionableMethodShortParams' metadata when there are
 ...
 * @package    Zefram_Tool
 */
class Zefram_Tool_Framework_Client_Console_Manifest extends Zend_Tool_Framework_Client_Console_Manifest
{
    /**
     * {@inheritDoc}
     *
    ...
    public function getMetadata()
    {
        ...
        // are found, remove 'actionableMethodShortParams' metadata, effectively
        // making this action not callable with short params.
        foreach ($metadata as $index => $metadatum) {
            if ($metadatum->getName() !== 'actionableMethodShortParams') {
                continue;
            }
